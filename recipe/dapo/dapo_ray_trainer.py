    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                elif 'rejection_pos_answer_ids' in new_batch.batch.keys():
                    gen_batch = new_batch.pop(
                        batch_keys=["input_ids", "attention_mask", "position_ids", 'rejection_pos_answer_ids'],
                ...
                with _timer("step", timing_raw):
                    ...
                    new_batch = new_batch.repeat(repeat_times=self.config.actor_rollout_ref.rollout.n + self.config.data.experience_replay_num, interleave=True)
                    ...
                    with _timer("old_log_prob", timing_raw):
                        ...
                        # old_log_prob.batch.pop("entropys") # hongzhi edit
